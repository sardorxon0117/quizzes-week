    ...
    <div>
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="flex gap-2">
          <button
            ...
            className="px-4 py-2.5 text-sm font-bold border-2 border-neutral-900 text-neutral-900 hover:bg-neutral-900 hover:text-white transition-colors"
          >
            Hammasini PDF
          </button>
          <button
      ...
      {questions.length === 0 ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {questions.map((q) => (
            <div key={q.id} className="bg-white border-2 border-neutral-900 p-4 flex flex-col">
              ...
              {qrMap[q.code] && (
                <img src={qrMap[q.code]} alt={`QR ${q.code}`} className="w-24 h-24 mx-auto mb-3" />
              )}
              ...
              <div className="mt-auto flex flex-wrap gap-1.5 pt-2 border-t border-neutral-100">
                <button
                  onClick={() => handlePdf(q)}
      ...
      {showForm && (
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-5 z-50">
          <div className="bg-white border-2 border-neutral-900 w-full max-w-md p-6">
          ...
          <div className="bg-white border-2 border-neutral-900 w-full max-w-sm p-6 text-center">
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="flex-1 py-2.5 font-bold text-white bg-red-600"
              >
                O'chirish
              </button>
            </div>
